...
const selectedProduct = {
    ...
    price: 1233,
    originPrice: 123,
    description: "This is a stylish jacket sdf dfer wwerwr ert",
    material: "Leather",
    sizes: ["S", "M", "XL"],
    colors: ["red", "black", "white"],
    images: [
        { url: "https://picsum.photos/500/500?random=1", altText: "Stylish Jacket1" },
        { url: "https://picsum.photos/500/500?random=2", altText: "Stylish Jacket2" }
    ]
};
    ...
    const handleAddToCart = () => {
        if (!selectedSize || !selectedColor) {
            toast.error("Please select a size and color before adding to cart.", {
                duration: 1500,
                style: { background: '#dc2626', color: 'white' } // bg-red-600
            });
            return;
        }
                ...
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="md:w-1/2 md:ml-10">
                        ...
                        <p className="text-lg text-gray-600 mb-1 line-through">
                            {selectedProduct.originPrice && `Rp. ${selectedProduct.originPrice}`}
                        </p>
                            ...
                            <div className="flex gap-2 mt-2">
                                {selectedProduct.colors.map((color) => (
                                    <button 
                                        ...
                                        style={{ backgroundColor: color.toLowerCase(), filter: selectedColor === color ? "brightness(1)" : "brightness(0.8)" }}>
                                    </button>
                                ))}
                            </div>
                        </div>
